  ...
  return (
    <div className="max-w-[800px] space-y-4 py-16 px-8 sm:px-24 sm:pt-16 pb-32">
      ...
      <div className="border-b border-zinc-800 pb-4">
        <div className="text-md text-cyan-500">Answer</div>
      ...
      {done && (
        <>
          ...
          <button className="flex h-10 w-52 items-center justify-center rounded-md bg-gradient-to-r bg-amber-500 p-2 hover:cursor-pointer hover:bg-yellow-500">
            <IconReload size={18} />
